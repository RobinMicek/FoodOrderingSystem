...
<template>
    ...
    <TopBar backLink="/" text="Vyberte Provozovnu"/>
        ...
        <div v-if="establishments && establishments.length != 0" class="w-full">
            <pull-to-refresh @refresh="refreshData">
                <div v-for="establishment in establishments">                    
                    ...
                    <div v-if="establishment.isOpen.isOpen">
                        <router-link :to="{ name: 'menus', query: { establishmentId: establishment.establishmentId } }">
                            <div class="mb-3vh relative h-20vh grid grid-cols-3 w-full bg-white rounded-lg">
                                
                                <div class="col-span-1">
                                    <img :src="serverUrl + establishment.imagePath" class="h-20vh w-full object-cover rounded-tl-lg rounded-bl-lg">
                                </div>
                    ...
                    <div v-else>                    
                        <div class="mb-3vh relative h-20vh grid grid-cols-3 w-full bg-white rounded-lg" onclick="alert('Tato provozovna momentálně není otevřená.')"> 
