...
INSERT INTO kOkenku.products (productId, name, description, price, preparationTime, imagePath, `show`) VALUES(14, 'Smazané Cibulové Kroužky', 'Křupavé smažené kroužky cibule, podávané s pikantní omáčkou.', 49.9, '00:08:00', '/files/storage/images/products/U8Ggyvi5dB.png', 1);
