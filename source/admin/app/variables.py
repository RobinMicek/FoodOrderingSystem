...
# HASHING
HASH_SALT = "MyHashingSalt" # Needs to be the same as the hash salt in an client app
...
DB_USER = "root" # str(os.environ.get("KO_DB_USER", None))
DB_PASSWORD = "root" # str(os.environ.get("KO_DB_PASSWORD", None))
